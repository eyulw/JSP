...
<form action="../member/modifyProcess" method="post" class="join" name="joinForm">
  <div class="container-sm">
    <div class="row justify-content-center">
      <div class="col-6">
        <div class="input-group mb-3"><input type="text" name="userId" class="form-control userId" id="floatingInput" placeholder="아이디를 입력해 주세요" value="${memberInfoDto.id}" readonly /></div>
        <div class="mb-3">
        ...
        <div class="mb-5">
          ...
          <input type="text" name="userName" class="form-control" id="floatingName" placeholder="이름" value="${memberInfoDto.name}" />
        </div>
        <div class="mb-5">
          <label for="floatingEmail">Email</label>
          <input type="email" name="userEmail" class="form-control" id="floatingEmail" placeholder="이메일을 입력해 주세요" value="${memberInfoDto.email}" readonly />
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="userAddress" class="form-control address" id="floatingAddress" placeholder="주소를 입력해 주세요" value="${memberInfoDto.address}" />
        </div>
        <div class="row mb-3">
          <div class="col">
            <input type="text" class="form-control detailAddress" name="detailAddress" placeholder="상세주소" value="${memberInfoDto.detailaddress}" />
          </div>
          <div class="col">
            <input type="text" class="form-control extraAddress" name="extraAddress" placeholder="참고사항" value="${memberInfoDto.extraaddress}" />
          </div>
        </div>
        <div class="text-center">
          <button type="submit" class="btn btn-primary btn-lg" id="btnSubmit">MODIFY</button>
        </div>
      </div>
    </div>
  </div>
