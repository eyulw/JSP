...
String sql = "select id,name,email,address,lpad(zonecode,5,'0') as changeZonecode ,detailaddress,extraaddress from member where id=?";
...
<form action="modify-process.jsp" method="post" class="join" name="joinForm">
  <div class="container-sm">
    <div class="row justify-content-center">
      <div class="col-6">
        <div class="input-group mb-3"><input type="text" name="userId" class="form-control userId" id="floatingInput" placeholder="아이디를 입력해 주세요" value="<%=pLoggedUserId%>" readonly /></div>
        <div class="mb-3">
        ...
        <div class="mb-5">
          ...
          <input type="text" name="userName" class="form-control" id="floatingName" placeholder="이름" value="<%=name%>" />
        </div>
        <div class="mb-5">
        ...
        <div class="row mb-3">
          <div class="col">
            <input type="text" class="form-control detailAddress" name="datailAddress" placeholder="상세주소" value="<%=detailAddress%>" />
          </div>
          <div class="col">
            <input type="text" class="form-control extraAddress" name="extraAddress" placeholder="참고사항" value="<%=extraAddress%>" />
          </div>
        </div>
